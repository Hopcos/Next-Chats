...
public interface ILlmRouter
{
    ...
    /// <summary>获取客户端（失败自动 failover 到下一供应商）；lang 影响 Mock 等本地化输出</summary>
    Task<ILlmClient> SelectClientAsync(Guid? preferredId = null, Guid? preferredModelId = null, string? lang = null, CancellationToken ct = default);
